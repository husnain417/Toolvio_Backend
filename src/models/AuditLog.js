...
const AuditLogSchema = new mongoose.Schema({
  ...
  // Deduplication field: unique identifier for same operation within time window
  deduplicationKey: {
    type: String,
    required: true,
    index: true
...
// Deduplication index: prevent duplicate audit logs
AuditLogSchema.index({ deduplicationKey: 1 }, { unique: true });
